...
int _kOperationStateValues[] = {
  ...
  OperationState::R_SUCCESS,
  OperationState::R_FAIL_TIMEOUT,
  OperationState::W_SUCCESS,
  OperationState::W_FAIL_LATE,
...
void ReadReply::__set_ts(const Timestamp val) {
  this->ts = val;
}
...
void WriteReply::__set_ts(const Timestamp val) {
  this->ts = val;
}
