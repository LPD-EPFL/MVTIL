...
class DataServiceIf {
 public:
  ...
  virtual void HandleAbort(AbortReply& _return, const TransactionId tid, const Timestamp ts) = 0;
  virtual void HandleCommit(CommitReply& _return, const TransactionId tid, const Timestamp ts) = 0;
  virtual void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Timestamp ts, const Key& k) = 0;
  virtual void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Timestamp ts, const Key& k, const Value& v) = 0;
};
...
typedef struct _DataService_HandleAbort_args__isset {
  _DataService_HandleAbort_args__isset() : tid(false), ts(false) {}
  bool tid :1;
  bool ts :1;
...
class DataService_HandleAbort_args {
 public:
  ...
  DataService_HandleAbort_args() : tid(0), ts(0) {
  }
...
typedef struct _DataService_HandleReadRequest_args__isset {
  _DataService_HandleReadRequest_args__isset() : tid(false), ts(false), k(false) {}
  bool tid :1;
  bool ts :1;
  bool k :1;
...
class DataService_HandleReadRequest_args {
 public:
  ...
  DataService_HandleReadRequest_args() : tid(0), ts(0), k() {
  }
...
typedef struct _DataService_HandleWriteRequest_args__isset {
  _DataService_HandleWriteRequest_args__isset() : tid(false), ts(false), k(false), v(false) {}
  bool tid :1;
  bool ts :1;
  bool k :1;
  bool v :1;
...
class DataService_HandleWriteRequest_args {
 public:
  ...
  DataService_HandleWriteRequest_args() : tid(0), ts(0), k(), v() {
  }
...
class DataServiceClient : virtual public DataServiceIf {
 ...
 public:
  ...
  void HandleAbort(AbortReply& _return, const TransactionId tid, const Timestamp ts);
  void send_HandleAbort(const TransactionId tid, const Timestamp ts);
  ...
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Timestamp ts, const Key& k);
  void send_HandleReadRequest(const TransactionId tid, const Timestamp ts, const Key& k);
  void recv_HandleReadRequest(ReadReply& _return);
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Timestamp ts, const Key& k, const Value& v);
  void send_HandleWriteRequest(const TransactionId tid, const Timestamp ts, const Key& k, const Value& v);
...
class DataServiceMultiface : virtual public DataServiceIf {
 ...
 public:
  void HandleAbort(AbortReply& _return, const TransactionId tid, const Timestamp ts) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleAbort(_return, tid, ts);
    }
    ifaces_[i]->HandleAbort(_return, tid, ts);
    return;
  }
  ...
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Timestamp ts, const Key& k) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleReadRequest(_return, tid, ts, k);
    }
    ifaces_[i]->HandleReadRequest(_return, tid, ts, k);
    return;
  }
  ...
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Timestamp ts, const Key& k, const Value& v) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleWriteRequest(_return, tid, ts, k, v);
    }
    ifaces_[i]->HandleWriteRequest(_return, tid, ts, k, v);
    return;
  }
...
class DataServiceConcurrentClient : virtual public DataServiceIf {
 ...
 public:
  ...
  void HandleAbort(AbortReply& _return, const TransactionId tid, const Timestamp ts);
  int32_t send_HandleAbort(const TransactionId tid, const Timestamp ts);
  ...
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Timestamp ts, const Key& k);
  int32_t send_HandleReadRequest(const TransactionId tid, const Timestamp ts, const Key& k);
  void recv_HandleReadRequest(ReadReply& _return, const int32_t seqid);
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Timestamp ts, const Key& k, const Value& v);
  int32_t send_HandleWriteRequest(const TransactionId tid, const Timestamp ts, const Key& k, const Value& v);
