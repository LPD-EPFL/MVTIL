...
typedef struct _ReadReply__isset {
  _ReadReply__isset() : tid(false), ts(false), state(false), key(false), value(false) {}
  bool tid :1;
  bool ts :1;
  bool state :1;
  bool key :1;
...
class ReadReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  ReadReply() : tid(0), ts(0), state((OperationState::type)0), key(), value() {
  }
...
typedef struct _WriteReply__isset {
  _WriteReply__isset() : tid(false), ts(false), state(false), key(false) {}
  bool tid :1;
  bool ts :1;
  bool state :1;
  bool key :1;
...
class WriteReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  WriteReply() : tid(0), ts(0), state((OperationState::type)0), key() {
  }
