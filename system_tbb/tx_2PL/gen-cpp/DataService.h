...
class DataServiceIf {
 public:
  ...
  virtual void HandleCommit(CommitReply& _return, const TransactionId tid) = 0;
  virtual void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Key& k, const bool isReadOnly) = 0;
  virtual void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Key& k, const Value& v) = 0;
};
...
typedef struct _DataService_HandleCommit_args__isset {
  _DataService_HandleCommit_args__isset() : tid(false) {}
  bool tid :1;
...
class DataService_HandleCommit_args {
 public:
  ...
  DataService_HandleCommit_args() : tid(0) {
  }
...
typedef struct _DataService_HandleReadRequest_args__isset {
  _DataService_HandleReadRequest_args__isset() : tid(false), k(false), isReadOnly(false) {}
  bool tid :1;
  bool k :1;
  bool isReadOnly :1;
...
class DataService_HandleReadRequest_args {
 public:
  ...
  DataService_HandleReadRequest_args() : tid(0), k(), isReadOnly(0) {
  }
...
typedef struct _DataService_HandleWriteRequest_args__isset {
  _DataService_HandleWriteRequest_args__isset() : tid(false), k(false), v(false) {}
  bool tid :1;
  bool k :1;
  bool v :1;
...
class DataServiceClient : virtual public DataServiceIf {
 ...
 public:
  ...
  void HandleCommit(CommitReply& _return, const TransactionId tid);
  void send_HandleCommit(const TransactionId tid);
  void recv_HandleCommit(CommitReply& _return);
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Key& k, const bool isReadOnly);
  void send_HandleReadRequest(const TransactionId tid, const Key& k, const bool isReadOnly);
  void recv_HandleReadRequest(ReadReply& _return);
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Key& k, const Value& v);
  void send_HandleWriteRequest(const TransactionId tid, const Key& k, const Value& v);
...
class DataServiceMultiface : virtual public DataServiceIf {
 ...
 public:
  ...
  void HandleCommit(CommitReply& _return, const TransactionId tid) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleCommit(_return, tid);
    }
    ifaces_[i]->HandleCommit(_return, tid);
    return;
  }
  ...
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Key& k, const bool isReadOnly) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleReadRequest(_return, tid, k, isReadOnly);
    }
    ifaces_[i]->HandleReadRequest(_return, tid, k, isReadOnly);
    return;
  }
  ...
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Key& k, const Value& v) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->HandleWriteRequest(_return, tid, k, v);
    }
    ifaces_[i]->HandleWriteRequest(_return, tid, k, v);
    return;
  }
...
class DataServiceConcurrentClient : virtual public DataServiceIf {
 ...
 public:
  ...
  void HandleCommit(CommitReply& _return, const TransactionId tid);
  int32_t send_HandleCommit(const TransactionId tid);
  void recv_HandleCommit(CommitReply& _return, const int32_t seqid);
  void HandleReadRequest(ReadReply& _return, const TransactionId tid, const Key& k, const bool isReadOnly);
  int32_t send_HandleReadRequest(const TransactionId tid, const Key& k, const bool isReadOnly);
  void recv_HandleReadRequest(ReadReply& _return, const int32_t seqid);
  void HandleWriteRequest(WriteReply& _return, const TransactionId tid, const Key& k, const Value& v);
  int32_t send_HandleWriteRequest(const TransactionId tid, const Key& k, const Value& v);
